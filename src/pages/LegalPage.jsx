        ...
        <div className="space-y-12 typo-body text-xs sm:text-sm text-muted leading-relaxed">
          ...
          <section id="mentions" className="scroll-mt-32 space-y-4 p-6 sm:p-8 bg-surface/60 border border-white/5 rounded-none">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-ivoire font-serif-luxury text-xl sm:text-2xl">
            ...
            <div className="space-y-3 pt-2 text-muted">
              ...
              <ul className="list-disc list-inside space-y-1 pl-2 text-xs">
                <li><strong>{lang === 'it' ? 'Sede Legale:' : lang === 'en' ? 'Headquarters:' : 'Siège Social :'}</strong> Via Monte Napoleone 14, 20121 Milano, Italia</li>
                <li><strong>{lang === 'it' ? 'Direttore Responsabile:' : lang === 'en' ? 'Managing Director:' : 'Directeur de la Publication :'}</strong> Vincenzo Moretti (Chef Propriétaire)</li>
                <li><strong>{lang === 'it' ? 'Direzione Creativa & Sommelier:' : lang === 'en' ? 'Creative Direction & Sommelier:' : 'Direction de Création & Sommellerie :'}</strong> Gianluca Ferri</li>
                <li><strong>{lang === 'it' ? 'Telefono Concierge:' : lang === 'en' ? 'Concierge Phone:' : 'Téléphone Conciergerie :'}</strong> {restaurantInfo.phone}</li>
                <li><strong>{lang === 'it' ? 'Email Concierge:' : lang === 'en' ? 'Concierge Email:' : 'Courriel Conciergerie :'}</strong> {restaurantInfo.email}</li>
                <li><strong>{lang === 'it' ? 'Hosting Cloud:' : lang === 'en' ? 'Cloud Hosting:' : 'Hébergement :'}</strong> Infrastructure Cloud ISO 27001 & GDPR.</li>
              </ul>
            </div>
          </section>
          ...
          <section id="rgpd" className="scroll-mt-32 space-y-4 p-6 sm:p-8 bg-surface/60 border border-or-subtle rounded-none">
            ...
            <div className="space-y-3 pt-2 text-muted">
              ...
              <div className="space-y-2 pt-2">
                <h3 className="text-ivoire font-medium text-sm uppercase tracking-wider text-xs">
